...
#						h2o=value.pts["H2O(WT%)"]
					...
					if l[0][0]==0 and l[1][0]==0:
						...
						if symbol=="d":
							...
							if cpx_out==1:
								plt.plot(l[0][1],katz_mf,markeredgecolor='g',markerfacecolor='None',markersize=30,marker=symbol,label="Kelley samples, katz" if i==0 else "")
							elif cpx_out==0:
								plt.plot(l[0][1],katz_mf,color='g',markersize=30,marker=symbol,label="Kelley samples,katz" if i==0 else "")
							plt.plot(l[0][1],value.kelley_mf_arc(comp,l[0],h2o),color='r',markersize=30,marker=symbol,label="Kelley samples, kelley" if i==0 else "")
						elif symbol=="s":
							...
							katz_mf,cpx_out=value.katz_mf(comp,0.12,l[0],h2o)
							if cpx_out==1:
								plt.plot(l[0][1],katz_mf,markeredgecolor='g',markerfacecolor='None',markersize=30,marker=symbol,label="My samples, Katz" if i==0 else "")
							elif cpx_out==0:
								plt.plot(l[0][1],katz_mf,color='g',markersize=30,marker=symbol,label="My samples Katz" if i==0 else "")
							plt.plot(l[0][1],value.kelley_mf_arc(comp,l[0],h2o),color='r',markersize=30,marker=symbol,label="My samples kelley" if i==0 else "")
					i+=1			
...
#		plt.scatter(0,0,label=name,marker="s",edgecolor="g",facecolors=col)
	...
	fig1.savefig("%skatz_kelley_mf_vs_P.png"%(directory),bbox_inches='tight',dpi=(149))
