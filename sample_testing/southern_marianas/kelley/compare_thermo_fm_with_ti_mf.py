			...
			for comp in [0.9]:
				...
				for key,value in samps.iteritems():
					...
					if l[0][0]==0 and l[1][0]==0:
						...
						if symbol=="d":
							#mf_vals.append()
							print key,value.kelley_mf_arc(comp,l[0],h2o),value.quick_mf(value.tio2,0.04,0.123)
							...
							plt.plot(latitude,value.kelley_mf_arc(comp,l[0],h2o),markeredgecolor='g',markersize=30,markerfacecolor='None',marker="s")
							mf_vals.append(value.quick_mf(value.tio2,0.04,0.123))
#						elif symbol=="s":
