...
\item As do not know pre-eruptive H\textsubscript{2}O in our samples, there is uncertainty in melt fractions. See figure \ref{h2o_effect_mf}. This is minor - 2\% melt fraction increase between 0 and 8 wt\% H$_2$O.
\item Melt fraction differences calculated using Kelley thermobarometry and Ti have significant differences, when calculated on sample by sample basis.
\item Inclusion of cpx-out from \cite{katz2003} allows reconciliation within \pm 5\% melt fraction (figure \ref{mf_diff_cpx_out})
\end{itemize}
\begin{figure}[H]
...
\input{kelley_katz_comparison/katz_kelley_comparison.tex}
\begin{figure}[H]
%/data/ap4909/30.10.2013-hot_cold_geochem/sample_testing/southern_marianas/kelley/mf_vs_ti.py
