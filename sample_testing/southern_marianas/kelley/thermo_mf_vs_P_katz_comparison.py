			...
			for comp in [0.9]:	
				for key,value in samps.iteritems():
					if symbol=="d":
						...
						mf_vals.append(value.kelley_mf_arc(comp,l[0],h2o))
						#print find_sample_cpx(h2o,value)
						mf_vals_katz.append(value.katz_mf_new(comp,find_sample_cpx(h2o,value),l[0],h2o))
...
#							print key
		...
		plt.scatter(mf_vals_katz,P_vals,marker=symbol,c=colour,facecolors='none',label=label,s=100)
...
fig1.savefig("%sthermo_mf_vs_P_katz_comparison.png"%(directory),bbox_inches='tight',dpi=(149))
plt.show()
