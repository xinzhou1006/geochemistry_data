#Python version of vba macro in Lee et al 2009 spreadsheet. Used for Kelley samples in which H2O content is available.
def fractionate(ele_d,H2Omelt1,fo2,Fomax,mass_inc=0.00005,Kd_var=1,MgO_min=6.0):#ele_d=dict of element concentrations,h2o=h2o content of melt, fo2=oxidation of mantle,Fo=forsterite content of mantle,Kd_var (1=variable Kd, 0 =non variable Kd)
	...
	H2Omelt1= try_strings.try_strings(["H2O(WT%)","H2O(WT%): altern. values or methods","H2O(WT%): altern. values and methods"],ele_d)
	#H2Omelt1 = ele_d["H2O"]
